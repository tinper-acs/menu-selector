...
var Select = (_temp = _class = function (_React$Component) {
  ...
  */
  ...
  clearIcon: _react2["default"].createElement(_nextUi.Icon, { className: 'rc-tree-select-selection-choice-clear-icon', type: ' uf-close-c' }), //是单选最后的X
  removeIcon: _react2["default"].createElement(_nextUi.Icon, { className: 'rc-tree-select-selection-choice-remove-icon', type: ' uf-close' }), // 每项的关闭
  menuIcon: _react2["default"].createElement(_nextUi.Icon, { className: 'rc-tree-select-selection-menu-icon', type: ' uf-navmenu' }), // 每项的关闭
