...
var BasePopup = (_temp = _class = function (_React$Component) {
  ...
  BasePopup.prototype.render = function render() {
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(_nextUi.Spin, { className: dropdownPrefixCls + '-loading', spinning: this.props.loading, getPopupContainer: this }),
      renderSearch ? renderSearch() : null,
      !topPagination && $content,
      !!pageCount && _react2["default"].createElement(
        'div',
        { className: dropdownPrefixCls + '-pagination' },
        _react2["default"].createElement(_nextUi.Pagination, {
          first: true,
          last: true,
          prev: true,
          next: true,
